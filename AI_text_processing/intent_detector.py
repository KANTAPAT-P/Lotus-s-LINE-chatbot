...
INTENT_KEYWORDS = {
    "greeting": [
        ...
        "สวัดี", "สวัสด",  # เผื่อพิมพ์ผิด (ตกตัวอักษร) — เพิ่มตรง ๆ แบบง่ายสุด
                            # ไม่ทำ fuzzy matching เต็มรูปแบบเหมือนฝั่ง entity
                            # เพราะ greeting มีคำจำกัด พิมพ์ผิดที่พบบ่อยเพิ่ม
                            # เข้า list ตรง ๆ ง่ายกว่าและเสี่ยงน้อยกว่า
    ],
    "ask_promotion": [
