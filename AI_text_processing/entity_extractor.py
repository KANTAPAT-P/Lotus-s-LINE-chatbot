...
#
# --- บันทึกการแก้บั๊ก: เดิมตั้งไว้ที่ 75 ต่ำกว่า UPGRADE_SCORE_THRESHOLD
# (85) เพราะคิดว่า "การอัปเกรดต้องมั่นใจสูงกว่า" แต่ทดสอบกับข้อมูลจริง
# แล้วพบว่าคิดผิดทาง: เจอเคส "ทดสอบข้อความมั่ว ๆ xyz123" ไป fuzzy match
# ผิดกับหมวด "ถั่ว" ได้คะแนนพอดี 75.0 (เท่ากับ threshold เป๊ะ ผ่านแบบ
# เฉียดฉิว) เพราะ "ถั่ว" กับ "มั่ว" (ที่อยู่ในข้อความมั่ว) สะกดคล้ายกัน
# มาก ต่างกันแค่พยัญชนะตัวแรก (ถ vs ม) ที่เหลือ "ั่ว" เหมือนกันหมด
#
# ที่จริงแล้ว fallback นี้ "เสี่ยงกว่า" upgrade เพราะค้นแบบไม่มีตัวกรอง
# ช่วยเลย (เทียบกับทุกชื่อทั้ง 833 แบบสุ่ม) ต่างจาก upgrade ที่เทียบ
# เฉพาะกลุ่ม candidate ที่กรองมาแล้วว่าเกี่ยวข้องกันจริง (ดู _SUPERSETS)
# จึงควรตั้งเกณฑ์เท่ากับหรือเข้มกว่า UPGRADE_SCORE_THRESHOLD ไม่ใช่
# หลวมกว่า จึงปรับขึ้นมาเท่ากัน (85) เพื่อกันเคสแบบ "ถั่ว/มั่ว" นี้
